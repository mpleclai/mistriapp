...
import com.thedullpencil.core.ui.R.string.core_ui_divider_tag
...
private fun Divider() = HorizontalDivider(
    Modifier
        ...
        .testTag(stringResource(core_ui_divider_tag))
)

@Composable
private fun Modifier.iconTag() = testTag(stringResource(R.string.core_ui_icon_tag))
